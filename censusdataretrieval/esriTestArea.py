...
blockGeometries = EsriDumper('https://tigerweb.geo.census.gov/arcgis/rest/services/Census2010/tigerWMS_Census2010/MapServer/14', extra_query_args={'where': 'STATE=\'26\''}) #get all blocks in Michigan (fips:26)
